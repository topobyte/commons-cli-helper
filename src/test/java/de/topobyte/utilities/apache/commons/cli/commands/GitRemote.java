...
public class GitRemote
{
	...
	public static ExeOptionsFactory OPTIONS_FACTORY = new ExeOptionsFactory() {
		...
		public ExeOptions createOptions()
		{
			...
			options.addCommand("add", GitRemoteAdd.OPTIONS_FACTORY,
					GitRemoteAdd.class);
			options.addCommand("rename", GitRemoteRename.OPTIONS_FACTORY,
					GitRemoteRename.class);
			options.addCommand("remove", GitRemoteRemove.OPTIONS_FACTORY,
					GitRemoteRemove.class);
			return options;
		}
